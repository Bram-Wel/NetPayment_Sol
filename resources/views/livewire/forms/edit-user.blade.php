<div class="flex justify-center">
    ...
    <form wire:submit.prevent="edit" class="w-1/2 bg-white rounded-md shadow-lg p-4">
        @csrf
        <h1 class="text-2xl font-bold border-b border-gray-800 w-32">Edit User</h1>
        <br>
        @if ($success)
        ...
        <input type="text" id="username" name="username" wire:model="username"
               class="w-full bg-white p-2 rounded border" readonly>
        <br>
        @error('username')
