<div class="bg-white p-5 ml-4 mr-4 shadow-xl rounded w-1/3">
    ...
    <form wire:submit.prevent="save" class="pt-4">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <select id="time" wire:model="time" placeholder="Time duration"
        ...
        <div class="mb-4 flex justify-center">
            <button type="submit"
                    class="bg-green-400 hover:shadow-2xl shadow hover:bg-green-600 text-white p-2 px-10 rounded-2xl">Add
            </button>
        </div>
    </form>
</div>
