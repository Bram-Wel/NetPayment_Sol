<nav x-data="{ open: false }"
     class="@if(!request()->routeIs('movies') and !request()->routeIs('test')) border-b border-gray-100 shadow-xl bg-white @endif @if(request()->routeIs('movies') and request()->routeIs('test')) absolute z-10 bg-transparent @endif">
